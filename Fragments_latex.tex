\documentclass[12pt,onecolumn,twoside,a4paper]{memoir}
                ...
                \sidenotemargin{left}
                %%%%%%%%%%%%%%%%%
                \title{Corpus sélectionné des fragments de tragédies de l'époque républicaine}
                \author{
               Pauline
               Jacsont
            }
            ...
            Texte latin établi et organisé selon les choix de reconstruction et d'édition de \cite{TrRF_I_2012}.
               ...
               \subsection*{Égisthe}
               \begin{abstract}
                  Source hellène : Sophocle \tg{\textit{Αἴγισθος}, Eschyle
                        \tg{\textit{Όρεστεια}.
                   L'intrigue est proche de l'\tg{\textit{Άγαμέμνων} d'Eschyle
                     et de la version latine de Sénèque: elle se concentre donc sur l'assassinat
                     d'Agamemnon par Égisthe et Clytemnestre.
               \end{abstract}
               \begin{pairs}
                  \begin{Leftside}
			\beginnumbering
